...
public class A8JediTestCompat {
	...
	public void testShellfishSpoil() throws PlatePriceException, BeltPlateException {
		...
		SpoiledEventObserverCompat test_observer = new SpoiledEventObserverCompat(b);
		full_rotate_belt(b);
...
class SpoiledEventObserverCompat implements Observer {
	private int spoiled_event_count;
	private Plate last_plate;
	
	public SpoiledEventObserverCompat(Belt b) {
